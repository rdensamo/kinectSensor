...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_b().pack(self.bitcount))
      ...
      _x = self
      buff.write(_get_struct_2i().pack(_x.trail, _x.gap))
      length = len(self.repeat)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.repeat))
      _x = self
      buff.write(_get_struct_2i().pack(_x.duty_cycle, _x.carrier_frequency))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.bitcount,) = _get_struct_b().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      (_x.trail, _x.gap,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      (_x.duty_cycle, _x.carrier_frequency,) = _get_struct_2i().unpack(str[start:end])
      return self
